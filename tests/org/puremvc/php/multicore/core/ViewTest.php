...
class ViewTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        // Test Factory Method
        $view = View::getInstance('ViewTestKey1');
    ...
    public function testRegisterAndNotifyObserver()
    {
        ...
        $view = View::getInstance('ViewTestKey2');
    ...
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey3');
    ...
    {
        // register a Mediator
        $view = View::getInstance('ViewTestKey4');
    ...
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey5');
    ...
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey6');
    ...
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey7');
     ...
     */
    public function testRemoveMediatorAndSubsequentNotify()
    {
        // Get the Multiton View instance
        $view = View::getInstance('ViewTestKey8');

        // Create and register the test mediator to be removed.
        $view->registerMediator( new ViewTestMediator2( 'ViewTestMediator2',$this ) );
     ...
     */
    public function testRemoveOneOfTwoMediatorsAndSubsequentNotify()
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey9');

        // Create and register that responds to notifications 1 and 2
        $view->registerMediator( new ViewTestMediator2( 'ViewTestMediator2',$this ) );

        // Create and register that responds to notification 3
        $view->registerMediator( new ViewTestMediator3( 'ViewTestMediator3',$this ) );
     ...
     */
    public function testMediatorReregistration()
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey10');

        // Create and register that responds to notification 5
        $view->registerMediator( new ViewTestMediator5('ViewTestMediator5', $this ) );
     ...
     * Added for the fix deployed in version 2.0.4
     */
    public function testModifyObserverListDuringNotification()
    {
        // Get the Singleton View instance
        $view = View::getInstance('ViewTestKey11');
        ...
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_1", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_2", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_3", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_4", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_5", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_6", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_7", $this) );
        $view->registerMediator( new ViewTestMediator6(ViewTestMediator6::NAME."_8", $this) );
    ...
    {
        //View::getInstance('test')->removeMediator( ViewTestMediator::NAME );
        //View::getInstance('test')->removeMediator( ViewTestMediator2::NAME );
        //View::getInstance('test')->removeMediator( ViewTestMediator3::NAME );
    }
}
